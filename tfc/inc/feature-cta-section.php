...
function tfc_footer_bar_customize_register( $wp_customize ) {
    ...
    $footer_widgets_four = $wp_customize->get_section( 'sidebar-widgets-footer-four-widgets' );
    if ( ! empty( $footer_widgets_four ) ) {
        $footer_widgets_four->priority = apply_filters( 'hestia_section_priority', 55, 'sidebar-widgets-footer-four-widgets' );
    }
